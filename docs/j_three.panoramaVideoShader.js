function jThreePanoramaVideoShader( videoElm, videoSrc, vertex, fragment, videoVolume, videoLoop ) {
    ...
    this.vertex = vertex.textContent;
    this.fragment = fragment.textContent;
    this.videoSrc = videoSrc;
    this.videoVolume = 1;
    this.videoLoop = true;
...
jThreePanoramaVideoShader.prototype.AudioInit = function() {
...
jThreePanoramaVideoShader.prototype.VideoInit = function() {
...
jThreePanoramaVideoShader.prototype.initThree = function() {
...
jThreePanoramaVideoShader.prototype.initCamera = function() {
...
jThreePanoramaVideoShader.prototype.initObject = function() {
...
jThreePanoramaVideoShader.prototype.onWindowResize = function(that) {
...
jThreePanoramaVideoShader.prototype.play = function(time) {
...
jThreePanoramaVideoShader.prototype.start = function() {
...
jThreePanoramaVideoShader.prototype.stop = function() {
...
jThreePanoramaVideoShader.prototype.pause = function() {
...
jThreePanoramaVideoShader.prototype.mute = function(volume) {
...
jThreePanoramaVideoShader.prototype.unmute = function(volume) {
...
jThreePanoramaVideoShader.prototype.volFadeOut = function(volume) {
...
jThreePanoramaVideoShader.prototype.volFadeIn = function(volume) {
...
jThreePanoramaVideoShader.prototype.stopToggle = function() {
    this.playing ? this.stop() : this.start();
};
jThreePanoramaVideoShader.prototype.pauseToggle = function() {
    this.playing ? this.pause() : this.start();
};
jThreePanoramaVideoShader.prototype.muteToggle = function(volume,volume2) {
    this.muting ? this.mute(volume) : this.unmute(volume2);
};
jThreePanoramaVideoShader.prototype.volFadeToggle = function(volume,volume2) {
...
jThreePanoramaVideoShader.prototype.render = function() {
